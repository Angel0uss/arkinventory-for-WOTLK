...
-- sorting
	...
	L["CONFIG_SORTMETHOD_INCLUDE_BAGSLOT"] = "bag / slot position"
	L["CONFIG_SORTMETHOD_INCLUDE_BAGSLOT_TEXT"] = "include the physical bag and slot position when sorting, letting you place it anywhere in the priority order instead of only as a final tiebreak"
	L["CONFIG_SORTMETHOD_INCLUDE_MANUAL"] = "manual order"
	L["CONFIG_SORTMETHOD_INCLUDE_MANUAL_TEXT"] = "use the order you set per category via the Edit Mode item right-click menu (Move Left / Move Right). items you haven't manually placed sort after the ones you have."
	L["CONFIG_SORTMETHOD_REVERSE"] = "Reverse"
	L["CONFIG_SORTMETHOD_REVERSE_TEXT"] = "reverse the order of just this one criteria, independent of the overall ascending/descending setting"
